...
class WidgetControl extends L.Control {
  ...
  onAdd(map) {
    if(this.options.transparentBg)
      ...
      this._container = L.DomUtil.create('div', 'mizar-widgetcontrol');
...
export class MizarWidgetControlModel extends control.MizarControlModel {
  defaults() {
    return {
      _view_name: 'MizarWidgetControlView',
      _model_name: 'MizarWidgetControlModel',
      widget: null,
      max_width: null,
      min_width: null,
      max_height: null,
...
MizarWidgetControlModel.serializers = {
  ...control.MizarControlModel.serializers,
  widget: { deserialize: widgets.unpack_models }
};

export class MizarWidgetControlView extends control.MizarControlView {
